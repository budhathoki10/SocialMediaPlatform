...
const userSchema = new Schema(
  {
    ...
    created_at: { type: Date, default: getKathmanduDate },
  },
  { collection: "users" },
);
...
const connectedAccountSchema = new Schema(
  {
    ...
    connected_at: { type: Date, default: getKathmanduDate },
...
const postSchema = new Schema(
  {
    ...
    scheduled_time: { type: Date, default: getKathmanduDate, index: true },
    created_at: { type: Date, default: getKathmanduDate },
...
const postPlatformSchema = new Schema(
  {
    ...
    published_at: { type: Date, default: getKathmanduDate },
...
const analyticsSchema = new Schema(
  {
    ...
    recorded_at: { type: Date, default: getKathmanduDate },
  },
