 ...
 * schema defaults if the user never saved settings. `settings.enabled` is
 * reserved for the future auto-post agent (sending without human review) —
 * it has no effect on draft generation; a human still approves every send
