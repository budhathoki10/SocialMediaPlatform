...
function connectedResponse(source, linkedin) {
  return NextResponse.json({
    connected: true,
    platform: "linkedin",
    authenticated: true,
    source,
    username: linkedin.username || linkedin.platform_username || null,
...
export async function GET() {
  ...
  if (!currentUser) {
    return NextResponse.json({ connected: false, platform: "linkedin", authenticated: false }, { status: 401 });
  }
